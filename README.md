<html>
    ...
    <style>
        body{
            background-image: url(https://images.alphacoders.com/924/thumb-1920-924472.jpg);
    ...
    <body>
        ...
        <p1><font face="Segoe Script" color="#ff0602" size="5">Internet consists of inter-connected networks.
        ...
        <br>
        <h2><font face="Comic Sans MS" color="lime" size="7"><center>HISTORY OF INTERNET</center></font></h2>
        <p><font face="Segoe Script" color="#ff0602" size="5">The seeds of internet were planned in 1969, when U.S. Department
            ...
            networks, which was later interconnected along with ARPANET and NSFnet to form Internet.</font></p>
            <br>
            <h3><font face="Comic Sans MS" color="black" size="7"><center>HOW INTERNET WORKS</center></font></h3>
            <p><font face="Segoe Script" color="#ff0602" size="5">The thing that characterizes the Internet is how data transferred
